...
/**
 * 
 * 同学网(http://www.tongxue.com)
 * 
 * 接口地址：url=http://www.tongxue.com/cz/sg/newfeed.php?account=8ae08986c75d2b389d9ab60e3b01&title=升了什么官
 ...
 *
 */
class TongxueService extends BaseService {
	//private $user;
	function TongxueService($user){
	...
	protected function sendAllUserAction($user, $title) {
		$url ="http://youxi.tongxue.com/newfeed.php?target=rxsg"; 
		if (SERVER_ID>1) $url =$url.SERVER_ID;		
	...
	function addGoodsEvent($goodsname, $goodsvalue) {
		$title ="被幸运星砸中大脑门，打开宝箱居然找到了".$goodsname."，价值".$goodsvalue."礼金啊   ";
		$this->sendAllUserAction($this->user,$title);
