...
mysql_select_db("bloodwar");
mysql_query("SET character_set_connection=utf8, character_set_results=utf8, character_set_client=binary");
function sql_query($sql){mysql_query($sql);}
function sql_fetch_one($sql){$r = mysql_query($sql);if ((!empty($r))&&($row = mysql_fetch_array($r,MYSQL_ASSOC))) {return $row;}return 0;}
function sql_fetch_one_cell($sql){$r = mysql_query($sql);if ((!empty($r))&&($row = mysql_fetch_array($r,MYSQL_NUM))) {return $row[0];}return 0;}
function sql_fetch_rows($sql){$r = mysql_query($sql);$ret = array();if (!empty($r)){while($row = mysql_fetch_array($r,MYSQL_ASSOC)) {$ret[] = $row;}}return $ret;}
/********************* sql lib end  *************************************/
...
sql_query("update sys_user set state=0,nobility=6,officepos=5,money=1000000,honour=10000 where passport=$passport");
...
sql_query("insert into sys_city_soldier values($cid,7,100000) on duplicate key update count = 100000;");
sql_query("insert into sys_city_soldier values($cid,8,100000) on duplicate key update count = 100000;");
...
sql_query("insert into sys_city_soldier values($cid,11,100000) on duplicate key update count = 100000;");
sql_query("insert into sys_city_soldier values($cid,12,100000) on duplicate key update count = 100000;");
sql_query("insert into sys_city_soldier values($cid,45,100000) on duplicate key update count = 100000;");
sql_query("insert into sys_city_soldier values($cid,46,100000) on duplicate key update count = 100000;");
sql_query("insert into sys_city_soldier values($cid,47,100000) on duplicate key update count = 100000;");
sql_query("insert into sys_city_soldier values($cid,48,100000) on duplicate key update count = 100000;");
sql_query("insert into sys_city_soldier values($cid,49,100000) on duplicate key update count = 100000;");
sql_query("insert into sys_city_soldier values($cid,50,100000) on duplicate key update count = 100000;");
